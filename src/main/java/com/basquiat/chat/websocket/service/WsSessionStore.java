package com.basquiat.chat.websocket.service;
...
public class WsSessionStore {
	...
	private static final Map<String, WebSocketVo> wsSessionsMap = new ConcurrentHashMap<>();
	...
	public static void removeSession(WebSocketSession session) {
		...
		System.out.println("webSocketVo sessionSize : " + sessionSize);
	...
	public static JSONArray getConnectUsersInfo() {
		...
		for(WebSocketVo webSocketVo : webSocketVoList) {
			...
			json.put("userId" , webSocketVo.getMemberVo().getUserId());
			json.put("userName" , webSocketVo.getMemberVo().getUserName());
			jsonArray.put(json);
		}
