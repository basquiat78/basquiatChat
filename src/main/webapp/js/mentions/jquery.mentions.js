...
(function() {
  ...
  $.widget("ui.areacomplete", $.ui.autocomplete, {
    ...
    selectCallback: function(event, ui) {
      $('.feed_comment').attr('style', 'overflow:hidden;');	
    ...
    _renderItem: function(ul, item) {
    	if(item.value !== undefined) {
    		$('.feed_comment').removeAttr('style');
    		var $a = $('<a>');
    		var dept = (item.dept==null || item.dept =='')?"":item.dept.substring(0,19);
    		var src = contextpath + '/chat/members/imgs?memberId=' + item.uid;
    		var value = item.value.replace(this.searchTerm.substring(), "<strong>$&</strong>");
    		$("<img style='height:40px;width:40px;display:inline-block;float:left;' src='"+src+"'/>").appendTo($a);
			$("<span style='margin-left:5px;font-size:13px;display:inline-block;'></span>").append(value).appendTo($a);
			$("<br></br>").appendTo($a);
			$("<span style='margin-left:5px;font-size:11px;display:inline-block;'></span>").text(dept).appendTo($a);
  ...
  MentionsInput = (function(_super) {
    ...
    function MentionsInput(input, options) {
      ...
      if(this.input.context.id === 'modifyCommentContentsInput'){
    	  box.css('border', '1px solid rgb(224, 224, 224)');
    	  container.css('margin', '0 0 0 -35px');
      }
      
      container.css('display', this.input.css('display'));
      container.css('width', '100%');
      if(this.input.context.id === 'feedContentsInput' || this.input.context.id === 'shareContentsInput' ){
    	  this.container = this.input.wrapAll(container).parent();
      } else {
    	  this.container = (this.input.wrapAll(box).parent()).wrapAll(container).parent();
      }
      ...
      //this.highlighter.css('display', 'none');
      ...
      if(contents != '') inputVal = contents;
      this._setValue(inputVal);
      this._initEvents();
    }
    ...
    MentionsInput.prototype._createHighlighter = function() {
      ...
      if(this.container.context.id === 'feedContentsInput' || this.container.context.id === 'shareContentsInput' ){
    	 content = $('<div>', {
    	         'class': 'highlighter-content',
    	         'style': 'margin:2px 0 0 2%; padding: 1% 4% 2% 0px; width: 94%;'	
    	 });
      } else {
    	 content = $('<div>', {
    	         'class': 'highlighter-content',
      ...
      if(this.container.context.id === 'feedContentsInput' || this.container.context.id === 'shareContentsInput' ){
      	//highlighter.css('width', '90%');
      	highlighter.css('border-width', '0px');
      	highlighter.css('margin', '0px');
      	highlighter.css('left', '0px');
      	//highlighter.css('top', '39px');
      	highlighter.css('right', '50px');
      	//highlighter.css('bottom', '0px');
      	highlighter.css('color', 'rgb(255, 255, 255)');
      	highlighter.css('line-height', 'normal');
      	highlighter.css('font-family', '"맑은 고딕", "Malgungothic", "nanumgothic", "돋움", Dotum, Tahoma, Geneva, sans-serif');
      	highlighter.css('font-size', '13px');
      	highlighter.css('font-style', 'normal');
      	highlighter.css('font-weight', '400');
      	highlighter.css('white-space', 'pre-wrap');
      	highlighter.css('position', 'absolute');
      	highlighter.css('-ms-word-wrap', 'break-word');
      	highlighter.css('box-sizing', 'content-box');
      	highlighter.css('background-color', 'rgb(255, 255, 255)');
    	...
    	for (_i = 0, _len = mimicProperties.length; _i < _len; _i++) {
      	...
      	highlighter.css('width', '94.7%');
      	highlighter.css('backgroundColor', '');
      	if(this.container.context.id === 'modifyFeedContentsInput') {
      		highlighter.css('margin', '2px 0 0 -9px');
      	} else if(this.container.context.id === 'modifyCommentContentsInput') {
      		highlighter.css('width', '86%');
      		highlighter.css('margin', '2px 0 0 -9px');
      	}
      }
    ...
    MentionsInput.prototype._updateValue = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        hlContent.push("<strong style='color: rgb(163, 188, 234); padding-right: 0px; display: inline-block; background-color: rgb(163, 188, 234);'>" + mention.name + "</strong>");
