	...
	RoomController.prototype =  {
		...
		getMessageByRoomId: function(roomId) {
			var me = this;
			var url = contextpath + "/messages/room/" + roomId + "/user/" + me.USERID;
		...
		getParticipatedRoomList: function(userId) {
			var me = this;
			var url = contextpath + "/rooms/user/" + userId;
			ajaxGET(url, null, function(data) {
		...
		getEstablishRoomList: function(userId) {
			var me = this;
			var url = contextpath + "/rooms/establisher/" + userId;
			ajaxGET(url, null, function(data) {
