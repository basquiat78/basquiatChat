...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/jquery/jquery.resize.js"></script>
		<script type="text/javascript" src="../js/jquery/jquery.elastic.js"></script>
		<script type="text/javascript" src="../js/mentions/jquery.events.input.js"></script>
		<script type="text/javascript" src="../js/mentions/jquery.mentions.js"></script>
	    <c:choose>
				<c:when  test="${operationModeRef eq 'stage'}">
					<script type="text/javascript" src="../js/websocket-chat-stage.js"></script>
				</c:when >
				<c:otherwise>
					<script type="text/javascript" src="../js/websocket-chat-dev.js"></script>
				</c:otherwise>
		</c:choose>
	    <script src="../js/util/ajaxUtil.js" charset="UTF-8"></script>
	    ...
	    <script type="text/javascript" src="../js/app/roomController.js"></script>
	    <script type="text/javascript" src="../js/app/alarmController.js"></script>
		<script type="text/javascript" src="../js/observer/lodash.js"></script>
